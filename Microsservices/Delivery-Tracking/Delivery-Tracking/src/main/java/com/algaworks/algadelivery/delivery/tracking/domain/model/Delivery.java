...
// Static method to create an instance of delivery in the Draft state, where it must have a valid identification and all other attributes set to null.
...
// Protected list; only the Delivery class can modify it.
    ...
    private boolean isFilled() {
        return this.getSender() != null && this.getRecipient() != null && getTotalCost() != null;
    }
